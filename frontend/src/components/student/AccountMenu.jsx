...
export default function AccountMenu() {
    ...
    useEffect(() => {
        const letter = localStorage.getItem("letter") || authUser.name[0];

        if (!localStorage.getItem("letter") || localStorage.getItem("letter") !== letter) {
                ...
                <Tooltip title="My Account">
                    ...
                    >
                        <Avatar sx={{ width: 32, height: 32, bgcolor: "light.main" }}>
                            <Typography color="secondary" fontWeight="bold">{localStorage.getItem("letter")}</Typography>
                        </Avatar>
                    </IconButton>
                </Tooltip>
            </Box>
