...
const { getAll, insert, update, remove, getOne, getJoined, getAttendance, present, absent, getAttendanceByMember, getAllAttendanceByMember } = require("../controllers/schedules");
const { club_admin_auth, student_auth, club_admin_student_auth, school_admin_auth } = require("../middlewares/auth");
...
router.get("/api/schedules/attendance/members", club_admin_auth, getAttendanceByMember);
router.get("/api/schedules/attendance/all/members", school_admin_auth, getAllAttendanceByMember);
